...
function create_banner_post_type()
{
    ...
    register_post_type('banner', [
        'labels' => [
            'name' => 'Банери',  // Загальна назва для цього типу запису
            'singular_name' => 'Банер',  // Одинична назва для цього типу запису
            'add_new' => 'Додати новий банер',  // Текст для кнопки додавання нового запису
            'add_new_item' => 'Додати новий банер',  // Текст для додавання нового елемента
            'edit_item' => 'Редагувати банер',  // Текст для редагування елемента
            'new_item' => 'Новий банер',  // Текст для нової позиції
            'view_item' => 'Переглянути банер',  // Текст для перегляду елемента
            'search_items' => 'Шукати банери',  // Текст для пошуку
            'not_found' => 'Банери не знайдено',  // Текст, що показується, коли немає записів
            'not_found_in_trash' => 'В кошику банери не знайдено',  // Текст, що показується, коли в кошику немає записів
            'all_items' => 'Банери',  // Текст для перегляду всіх елементів
            'archives' => 'Архів банерів',  // Архіви типу запису
        ],
