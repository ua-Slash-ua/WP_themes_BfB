...
function create_faq_post_type()
{
    ...
    register_post_type('faq', [
        'labels' => [
            'name' => 'Часті питання',  // Загальна назва для цього типу запису
            'singular_name' => 'Часте питання',  // Одинична назва для цього типу запису
            'add_new' => 'Додати нове питання',  // Текст для кнопки додавання нового запису
            'add_new_item' => 'Додати нове питання',  // Текст для додавання нового елемента
            'edit_item' => 'Редагувати питання',  // Текст для редагування елемента
            'new_item' => 'Нове питання',  // Текст для нової позиції
            'view_item' => 'Переглянути питання',  // Текст для перегляду елемента
            'search_items' => 'Шукати питання',  // Текст для пошуку
            'not_found' => 'Питання не знайдено',  // Текст, що показується, коли немає записів
            'not_found_in_trash' => 'В кошику питання не знайдено',  // Текст, що показується, коли в кошику немає записів
            'all_items' => 'FAQ',  // Текст для перегляду всіх елементів
            'archives' => 'Архів питань',  // Архіви типу запису
        ],
